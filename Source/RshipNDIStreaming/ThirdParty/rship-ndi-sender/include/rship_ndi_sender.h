 ...
 */
struct RshipNDISender *rship_ndi_create(const struct RshipNDIConfig *config);
 ...
 */
void rship_ndi_destroy(struct RshipNDISender *sender);
 ...
 */
bool rship_ndi_submit_frame(struct RshipNDISender *sender,
                            const struct RshipNDIFrame *frame);
 ...
 */
void rship_ndi_get_stats(const struct RshipNDISender *sender,
                         struct RshipNDIStats *stats);
