...
private:
	...
	// Last auto-generated default target id. If targetName still matches this at register-time,
	// we treat it as default and refresh from the current actor label/name.
	UPROPERTY()
	FString AutoGeneratedTargetNameBaseline;

	bool bIsRebindingSiblingContributors = false;
};
