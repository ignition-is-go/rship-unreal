...
fn get_tools() -> Vec<Tool> {
    vec![
        // ===== System Tools =====
        tool("ue5_system_info", "Get information about the UE5 editor and UltimateControl server",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_list_methods", "List all available JSON-RPC methods",
            json!({"type": "object", "properties": {}, "required": []})),

        // ===== Project Tools =====
        tool("ue5_project_info", "Get information about the current Unreal Engine project",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_project_save", "Save all dirty packages in the project",
            json!({"type": "object", "properties": {"prompt": {"type": "boolean", "default": false}}, "required": []})),

        // ===== Asset Tools =====
        tool("ue5_asset_list", "List assets in a content directory",
        ...
        tool("ue5_asset_get", "Get detailed information about a specific asset",
            json!({"type": "object", "properties": {"path": {"type": "string"}}, "required": ["path"]})),
        tool("ue5_asset_search", "Search for assets by name pattern",
            json!({"type": "object", "properties": {"query": {"type": "string"}, "class": {"type": "string"}, "limit": {"type": "integer", "default": 50}}, "required": ["query"]})),
        tool("ue5_asset_duplicate", "Duplicate an asset",
            json!({"type": "object", "properties": {"source": {"type": "string"}, "destination": {"type": "string"}}, "required": ["source", "destination"]})),
        tool("ue5_asset_delete", "Delete an asset (dangerous)",
            json!({"type": "object", "properties": {"path": {"type": "string"}}, "required": ["path"]})),
        tool("ue5_asset_import", "Import an external file as an asset",
            json!({"type": "object", "properties": {"file": {"type": "string"}, "destination": {"type": "string"}}, "required": ["file", "destination"]})),
        tool("ue5_asset_export", "Export an asset to a file",
            json!({"type": "object", "properties": {"path": {"type": "string"}, "destination": {"type": "string"}}, "required": ["path", "destination"]})),

        // ===== Blueprint Tools =====
        tool("ue5_blueprint_list", "List all blueprints in a path",
            json!({"type": "object", "properties": {"path": {"type": "string", "default": "/Game"}, "limit": {"type": "integer", "default": 100}}, "required": []})),
        tool("ue5_blueprint_get", "Get detailed blueprint information",
            json!({"type": "object", "properties": {"path": {"type": "string"}}, "required": ["path"]})),
        tool("ue5_blueprint_compile", "Compile a blueprint",
            json!({"type": "object", "properties": {"path": {"type": "string"}}, "required": ["path"]})),
        tool("ue5_blueprint_create", "Create a new blueprint class",
            json!({"type": "object", "properties": {"path": {"type": "string"}, "parentClass": {"type": "string", "default": "Actor"}}, "required": ["path"]})),
        tool("ue5_blueprint_get_graphs", "Get blueprint graph information",
            json!({"type": "object", "properties": {"path": {"type": "string"}}, "required": ["path"]})),
        tool("ue5_blueprint_get_variables", "Get blueprint variables",
            json!({"type": "object", "properties": {"path": {"type": "string"}}, "required": ["path"]})),
        tool("ue5_blueprint_add_variable", "Add a variable to a blueprint",
            json!({"type": "object", "properties": {"path": {"type": "string"}, "name": {"type": "string"}, "type": {"type": "string"}}, "required": ["path", "name", "type"]})),

        // ===== Level/Actor Tools =====
        tool("ue5_level_get_current", "Get information about the currently loaded level",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_level_open", "Open a level by path",
            json!({"type": "object", "properties": {"path": {"type": "string"}, "promptSave": {"type": "boolean", "default": true}}, "required": ["path"]})),
        tool("ue5_level_save", "Save the current level",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_level_list", "List all levels in the project",
            json!({"type": "object", "properties": {"path": {"type": "string", "default": "/Game"}}, "required": []})),
        tool("ue5_actor_list", "List actors in the current level",
            json!({"type": "object", "properties": {"class": {"type": "string"}, "tag": {"type": "string"}, "limit": {"type": "integer", "default": 100}}, "required": []})),
        tool("ue5_actor_get", "Get detailed information about an actor",
            json!({"type": "object", "properties": {"actor": {"type": "string"}}, "required": ["actor"]})),
        tool("ue5_actor_spawn", "Spawn a new actor in the level",
            json!({"type": "object", "properties": {"class": {"type": "string"}, "name": {"type": "string"}, "location": {"type": "object"}, "rotation": {"type": "object"}}, "required": ["class"]})),
        tool("ue5_actor_destroy", "Destroy an actor",
            json!({"type": "object", "properties": {"actor": {"type": "string"}}, "required": ["actor"]})),
        tool("ue5_actor_set_transform", "Set an actor's transform",
            json!({"type": "object", "properties": {"actor": {"type": "string"}, "location": {"type": "object"}, "rotation": {"type": "object"}, "scale": {"type": "object"}}, "required": ["actor"]})),
        tool("ue5_actor_get_property", "Get a property value from an actor",
            json!({"type": "object", "properties": {"actor": {"type": "string"}, "property": {"type": "string"}}, "required": ["actor", "property"]})),
        tool("ue5_actor_set_property", "Set a property value on an actor",
            json!({"type": "object", "properties": {"actor": {"type": "string"}, "property": {"type": "string"}, "value": {}}, "required": ["actor", "property", "value"]})),
        tool("ue5_selection_get", "Get currently selected actors",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_selection_set", "Set the selected actors",
            json!({"type": "object", "properties": {"actors": {"type": "array", "items": {"type": "string"}}, "add": {"type": "boolean", "default": false}}, "required": ["actors"]})),

        // ===== PIE Tools =====
        tool("ue5_pie_play", "Start Play In Editor session",
            json!({"type": "object", "properties": {"mode": {"type": "string", "default": "SelectedViewport"}}, "required": []})),
        tool("ue5_pie_stop", "Stop PIE session",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_pie_pause", "Pause/resume PIE",
            json!({"type": "object", "properties": {"pause": {"type": "boolean"}}, "required": []})),
        tool("ue5_pie_get_state", "Get PIE state",
            json!({"type": "object", "properties": {}, "required": []})),

        // ===== Console Tools =====
        tool("ue5_console_execute", "Execute a console command",
            json!({"type": "object", "properties": {"command": {"type": "string"}}, "required": ["command"]})),
        tool("ue5_console_get_variable", "Get a console variable value",
            json!({"type": "object", "properties": {"name": {"type": "string"}}, "required": ["name"]})),
        tool("ue5_console_set_variable", "Set a console variable",
            json!({"type": "object", "properties": {"name": {"type": "string"}, "value": {"type": "string"}}, "required": ["name", "value"]})),
        tool("ue5_console_list_variables", "List console variables",
            json!({"type": "object", "properties": {"filter": {"type": "string"}}, "required": []})),

        // ===== Viewport/Camera Tools =====
        tool("ue5_viewport_list", "List all active viewports",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_viewport_get_active", "Get the currently active viewport",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_viewport_set_active", "Set the active viewport by index",
            json!({"type": "object", "properties": {"index": {"type": "integer"}}, "required": ["index"]})),
        tool("ue5_viewport_get_camera", "Get viewport camera position and rotation",
            json!({"type": "object", "properties": {"viewportIndex": {"type": "integer", "default": 0}}, "required": []})),
        tool("ue5_viewport_set_camera", "Set viewport camera position and rotation",
            json!({"type": "object", "properties": {"viewportIndex": {"type": "integer", "default": 0}, "location": {"type": "object"}, "rotation": {"type": "object"}}, "required": []})),
        tool("ue5_viewport_focus_actor", "Focus viewport on a specific actor",
            json!({"type": "object", "properties": {"actor": {"type": "string"}}, "required": ["actor"]})),
        tool("ue5_viewport_screenshot", "Take a screenshot of the viewport",
            json!({"type": "object", "properties": {"filename": {"type": "string"}, "viewportIndex": {"type": "integer", "default": 0}}, "required": ["filename"]})),
        tool("ue5_viewport_set_view_mode", "Set viewport view mode (Lit, Unlit, Wireframe)",
            json!({"type": "object", "properties": {"mode": {"type": "string"}}, "required": ["mode"]})),

        // ===== Transaction/Undo Tools =====
        tool("ue5_transaction_begin", "Begin a new undo transaction",
            json!({"type": "object", "properties": {"description": {"type": "string"}}, "required": ["description"]})),
        tool("ue5_transaction_end", "End the current transaction",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_transaction_cancel", "Cancel the current transaction",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_undo", "Undo the last action",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_redo", "Redo the last undone action",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_undo_history", "Get the undo/redo history",
            json!({"type": "object", "properties": {"limit": {"type": "integer", "default": 20}}, "required": []})),

        // ===== Material Tools =====
        tool("ue5_material_list", "List materials in a path",
            json!({"type": "object", "properties": {"path": {"type": "string", "default": "/Game"}}, "required": []})),
        tool("ue5_material_get", "Get detailed material information",
            json!({"type": "object", "properties": {"path": {"type": "string"}}, "required": ["path"]})),
        tool("ue5_material_create", "Create a new material",
            json!({"type": "object", "properties": {"path": {"type": "string"}, "template": {"type": "string"}}, "required": ["path"]})),
        tool("ue5_material_get_parameters", "Get material parameters",
            json!({"type": "object", "properties": {"path": {"type": "string"}}, "required": ["path"]})),
        tool("ue5_material_set_scalar", "Set a scalar parameter on a material instance",
            json!({"type": "object", "properties": {"path": {"type": "string"}, "parameter": {"type": "string"}, "value": {"type": "number"}}, "required": ["path", "parameter", "value"]})),
        tool("ue5_material_set_vector", "Set a vector parameter on a material instance",
        ...
        tool("ue5_material_set_texture", "Set a texture parameter on a material instance",
        ...
        tool("ue5_material_instance_create", "Create a material instance from a parent",
            json!({"type": "object", "properties": {"path": {"type": "string"}, "parent": {"type": "string"}}, "required": ["path", "parent"]})),

        // ===== Animation Tools =====
        tool("ue5_animation_list", "List animation assets",
            json!({"type": "object", "properties": {"path": {"type": "string", "default": "/Game"}}, "required": []})),
        tool("ue5_animation_get", "Get animation asset details",
            json!({"type": "object", "properties": {"path": {"type": "string"}}, "required": ["path"]})),
        tool("ue5_animation_play", "Play an animation on an actor",
        ...
        tool("ue5_animation_stop", "Stop animation on an actor",
            json!({"type": "object", "properties": {"actor": {"type": "string"}}, "required": ["actor"]})),
        tool("ue5_animation_blueprint_list", "List Animation Blueprints",
            json!({"type": "object", "properties": {"path": {"type": "string", "default": "/Game"}}, "required": []})),

        // ===== Sequencer Tools =====
        tool("ue5_sequencer_list", "List Level Sequences in the project",
            json!({"type": "object", "properties": {"path": {"type": "string", "default": "/Game"}}, "required": []})),
        tool("ue5_sequencer_get", "Get sequence details",
            json!({"type": "object", "properties": {"path": {"type": "string"}}, "required": ["path"]})),
        tool("ue5_sequencer_open", "Open a sequence in the Sequencer editor",
            json!({"type": "object", "properties": {"path": {"type": "string"}}, "required": ["path"]})),
        tool("ue5_sequencer_play", "Play the current sequence",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_sequencer_stop", "Stop sequence playback",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_sequencer_set_time", "Set the playhead time in the sequence",
            json!({"type": "object", "properties": {"time": {"type": "number"}}, "required": ["time"]})),
        tool("ue5_sequencer_get_tracks", "Get all tracks in a sequence",
            json!({"type": "object", "properties": {"path": {"type": "string"}}, "required": ["path"]})),
        tool("ue5_sequencer_add_actor", "Add an actor binding to a sequence",
            json!({"type": "object", "properties": {"sequence": {"type": "string"}, "actor": {"type": "string"}}, "required": ["sequence", "actor"]})),

        // ===== Audio Tools =====
        tool("ue5_audio_list", "List audio assets",
            json!({"type": "object", "properties": {"path": {"type": "string", "default": "/Game"}}, "required": []})),
        tool("ue5_audio_play", "Play a sound at a location or attached to actor",
            json!({"type": "object", "properties": {"sound": {"type": "string"}, "actor": {"type": "string"}, "location": {"type": "object"}}, "required": ["sound"]})),
        tool("ue5_audio_stop_all", "Stop all playing sounds",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_audio_set_volume", "Set the master audio volume",
            json!({"type": "object", "properties": {"volume": {"type": "number"}}, "required": ["volume"]})),

        // ===== Physics Tools =====
        tool("ue5_physics_simulate", "Enable or disable physics simulation in editor",
            json!({"type": "object", "properties": {"enable": {"type": "boolean"}}, "required": ["enable"]})),
        tool("ue5_physics_get_body_info", "Get physics body information for an actor",
            json!({"type": "object", "properties": {"actor": {"type": "string"}}, "required": ["actor"]})),
        tool("ue5_physics_set_simulate", "Set physics simulation for an actor",
            json!({"type": "object", "properties": {"actor": {"type": "string"}, "simulate": {"type": "boolean"}}, "required": ["actor", "simulate"]})),
        tool("ue5_physics_apply_impulse", "Apply an impulse to a physics body",
            json!({"type": "object", "properties": {"actor": {"type": "string"}, "impulse": {"type": "object"}}, "required": ["actor", "impulse"]})),
        tool("ue5_collision_list_profiles", "List collision profiles",
            json!({"type": "object", "properties": {}, "required": []})),

        // ===== Lighting Tools =====
        tool("ue5_light_list", "List all lights in the current level",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_light_get", "Get light properties",
            json!({"type": "object", "properties": {"actor": {"type": "string"}}, "required": ["actor"]})),
        tool("ue5_light_set_intensity", "Set light intensity",
            json!({"type": "object", "properties": {"actor": {"type": "string"}, "intensity": {"type": "number"}}, "required": ["actor", "intensity"]})),
        tool("ue5_light_set_color", "Set light color",
            json!({"type": "object", "properties": {"actor": {"type": "string"}, "r": {"type": "number"}, "g": {"type": "number"}, "b": {"type": "number"}}, "required": ["actor", "r", "g", "b"]})),
        tool("ue5_light_build", "Build lighting for the level",
            json!({"type": "object", "properties": {"quality": {"type": "string", "default": "Production"}}, "required": []})),
        tool("ue5_light_build_reflection_captures", "Build reflection captures",
            json!({"type": "object", "properties": {}, "required": []})),

        // ===== World Partition / Data Layer Tools =====
        tool("ue5_world_partition_status", "Get World Partition status",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_world_partition_list_cells", "List World Partition cells",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_world_partition_load_cells", "Load specific cells",
            json!({"type": "object", "properties": {"cells": {"type": "array", "items": {"type": "string"}}}, "required": ["cells"]})),
        tool("ue5_data_layer_list", "List all data layers",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_data_layer_set_visibility", "Set data layer visibility",
            json!({"type": "object", "properties": {"layer": {"type": "string"}, "visible": {"type": "boolean"}}, "required": ["layer", "visible"]})),
        tool("ue5_data_layer_get_actors", "Get actors in a data layer",
            json!({"type": "object", "properties": {"layer": {"type": "string"}}, "required": ["layer"]})),

        // ===== Niagara/VFX Tools =====
        tool("ue5_niagara_list", "List Niagara systems",
            json!({"type": "object", "properties": {"path": {"type": "string", "default": "/Game"}}, "required": []})),
        tool("ue5_niagara_spawn", "Spawn a Niagara system at a location",
            json!({"type": "object", "properties": {"system": {"type": "string"}, "location": {"type": "object"}}, "required": ["system"]})),
        tool("ue5_niagara_activate", "Activate a Niagara component",
            json!({"type": "object", "properties": {"actor": {"type": "string"}}, "required": ["actor"]})),
        tool("ue5_niagara_deactivate", "Deactivate a Niagara component",
            json!({"type": "object", "properties": {"actor": {"type": "string"}}, "required": ["actor"]})),
        tool("ue5_niagara_set_float", "Set a float parameter on a Niagara component",
            json!({"type": "object", "properties": {"actor": {"type": "string"}, "parameter": {"type": "string"}, "value": {"type": "number"}}, "required": ["actor", "parameter", "value"]})),
        tool("ue5_niagara_set_vector", "Set a vector parameter on a Niagara component",
        ...
        // ===== Landscape Tools =====
        tool("ue5_landscape_list", "List landscapes in the level",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_landscape_get_height", "Get height at a world location",
            json!({"type": "object", "properties": {"x": {"type": "number"}, "y": {"type": "number"}}, "required": ["x", "y"]})),
        tool("ue5_landscape_list_layers", "List landscape paint layers",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_landscape_get_material", "Get landscape material",
            json!({"type": "object", "properties": {"landscape": {"type": "string"}}, "required": ["landscape"]})),

        // ===== AI/Navigation Tools =====
        tool("ue5_navigation_build", "Build navigation mesh",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_navigation_status", "Get navigation mesh status",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_navigation_find_path", "Find a navigation path between two points",
            json!({"type": "object", "properties": {"start": {"type": "object"}, "end": {"type": "object"}}, "required": ["start", "end"]})),
        tool("ue5_ai_list_controllers", "List AI controllers in the level",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_ai_move_to", "Command an AI to move to a location",
            json!({"type": "object", "properties": {"controller": {"type": "string"}, "location": {"type": "object"}}, "required": ["controller", "location"]})),
        tool("ue5_behavior_tree_list", "List Behavior Tree assets",
            json!({"type": "object", "properties": {"path": {"type": "string", "default": "/Game"}}, "required": []})),
        tool("ue5_behavior_tree_run", "Run a behavior tree on an AI controller",
            json!({"type": "object", "properties": {"controller": {"type": "string"}, "tree": {"type": "string"}}, "required": ["controller", "tree"]})),

        // ===== Render/PostProcess Tools =====
        tool("ue5_render_get_settings", "Get current render/quality settings",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_render_set_quality", "Set render quality level",
            json!({"type": "object", "properties": {"level": {"type": "integer"}}, "required": ["level"]})),
        tool("ue5_postprocess_list_volumes", "List PostProcess volumes in the level",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_postprocess_get", "Get PostProcess volume settings",
            json!({"type": "object", "properties": {"actor": {"type": "string"}}, "required": ["actor"]})),
        tool("ue5_postprocess_set_bloom", "Set bloom intensity on a PostProcess volume",
            json!({"type": "object", "properties": {"actor": {"type": "string"}, "intensity": {"type": "number"}}, "required": ["actor", "intensity"]})),
        tool("ue5_postprocess_set_exposure", "Set exposure settings",
            json!({"type": "object", "properties": {"actor": {"type": "string"}, "minEV": {"type": "number"}, "maxEV": {"type": "number"}}, "required": ["actor"]})),
        tool("ue5_render_get_show_flags", "Get viewport show flags",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_render_set_show_flag", "Set a viewport show flag",
            json!({"type": "object", "properties": {"flag": {"type": "string"}, "enabled": {"type": "boolean"}}, "required": ["flag", "enabled"]})),

        // ===== Outliner/Hierarchy Tools =====
        tool("ue5_outliner_get_hierarchy", "Get the actor hierarchy from the scene outliner",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_outliner_set_parent", "Set an actor's parent (attach)",
            json!({"type": "object", "properties": {"child": {"type": "string"}, "parent": {"type": "string"}}, "required": ["child", "parent"]})),
        tool("ue5_outliner_detach", "Detach an actor from its parent",
            json!({"type": "object", "properties": {"actor": {"type": "string"}}, "required": ["actor"]})),
        tool("ue5_outliner_list_folders", "List folders in the scene outliner",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_outliner_create_folder", "Create a folder in the scene outliner",
            json!({"type": "object", "properties": {"name": {"type": "string"}}, "required": ["name"]})),
        tool("ue5_outliner_set_folder", "Move an actor to a folder",
            json!({"type": "object", "properties": {"actor": {"type": "string"}, "folder": {"type": "string"}}, "required": ["actor", "folder"]})),
        tool("ue5_layer_list", "List editor layers",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_layer_create", "Create an editor layer",
            json!({"type": "object", "properties": {"name": {"type": "string"}}, "required": ["name"]})),
        tool("ue5_layer_add_actor", "Add an actor to a layer",
            json!({"type": "object", "properties": {"actor": {"type": "string"}, "layer": {"type": "string"}}, "required": ["actor", "layer"]})),
        tool("ue5_outliner_search", "Search for actors in the outliner",
            json!({"type": "object", "properties": {"query": {"type": "string"}}, "required": ["query"]})),

        // ===== Source Control Tools =====
        tool("ue5_source_control_status", "Get source control provider status",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_source_control_file_status", "Get source control status for a file",
            json!({"type": "object", "properties": {"path": {"type": "string"}}, "required": ["path"]})),
        tool("ue5_source_control_checkout", "Check out a file",
            json!({"type": "object", "properties": {"path": {"type": "string"}}, "required": ["path"]})),
        tool("ue5_source_control_checkin", "Check in a file with a description",
            json!({"type": "object", "properties": {"path": {"type": "string"}, "description": {"type": "string"}}, "required": ["path", "description"]})),
        tool("ue5_source_control_revert", "Revert changes to a file",
            json!({"type": "object", "properties": {"path": {"type": "string"}}, "required": ["path"]})),
        tool("ue5_source_control_sync", "Sync file(s) to latest",
            json!({"type": "object", "properties": {"path": {"type": "string"}}, "required": ["path"]})),
        tool("ue5_source_control_history", "Get file history",
            json!({"type": "object", "properties": {"path": {"type": "string"}}, "required": ["path"]})),

        // ===== Live Coding Tools =====
        tool("ue5_live_coding_status", "Get Live Coding status",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_live_coding_compile", "Trigger a Live Coding compile",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_live_coding_enable", "Enable Live Coding",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_live_coding_disable", "Disable Live Coding",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_hot_reload", "Trigger a hot reload (legacy)",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_module_list", "List loaded modules",
            json!({"type": "object", "properties": {}, "required": []})),

        // ===== Multi-User Session Tools =====
        tool("ue5_session_list", "List available Multi-User sessions",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_session_current", "Get current session info",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_session_join", "Join a Multi-User session",
            json!({"type": "object", "properties": {"session": {"type": "string"}}, "required": ["session"]})),
        tool("ue5_session_leave", "Leave the current Multi-User session",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_session_users", "List users in the current session",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_session_lock", "Lock an object for editing",
            json!({"type": "object", "properties": {"object": {"type": "string"}}, "required": ["object"]})),
        tool("ue5_session_unlock", "Unlock an object",
            json!({"type": "object", "properties": {"object": {"type": "string"}}, "required": ["object"]})),

        // ===== Editor UI Tools =====
        tool("ue5_editor_list_windows", "List open editor windows",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_editor_focus_window", "Focus a window by title",
            json!({"type": "object", "properties": {"title": {"type": "string"}}, "required": ["title"]})),
        tool("ue5_editor_list_tabs", "List tabs in the level editor",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_editor_open_tab", "Open a tab by ID",
            json!({"type": "object", "properties": {"tabId": {"type": "string"}}, "required": ["tabId"]})),
        tool("ue5_editor_get_mode", "Get current editor mode",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_editor_set_mode", "Set editor mode (e.g., Landscape, Foliage)",
            json!({"type": "object", "properties": {"modeId": {"type": "string"}}, "required": ["modeId"]})),
        tool("ue5_editor_get_transform_mode", "Get current transform gizmo mode",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_editor_set_transform_mode", "Set transform mode (Translate, Rotate, Scale)",
            json!({"type": "object", "properties": {"mode": {"type": "string"}}, "required": ["mode"]})),
        tool("ue5_editor_get_snap_settings", "Get current snap settings",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_editor_set_snap_settings", "Configure snap settings",
        ...
        tool("ue5_editor_show_notification", "Show a notification in the editor",
            json!({"type": "object", "properties": {"message": {"type": "string"}, "type": {"type": "string"}, "duration": {"type": "number", "default": 3.0}}, "required": ["message"]})),
        tool("ue5_editor_execute_command", "Execute an editor command",
            json!({"type": "object", "properties": {"command": {"type": "string"}}, "required": ["command"]})),
        tool("ue5_editor_open_settings", "Open project settings to a category",
            json!({"type": "object", "properties": {"category": {"type": "string"}}, "required": []})),

        // ===== Automation/Profiling Tools =====
        tool("ue5_automation_list_tests", "List available automation tests",
            json!({"type": "object", "properties": {"filter": {"type": "string"}}, "required": []})),
        tool("ue5_automation_run_tests", "Run automation tests",
            json!({"type": "object", "properties": {"tests": {"type": "array", "items": {"type": "string"}}}, "required": ["tests"]})),
        tool("ue5_profiling_get_stats", "Get performance statistics",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_profiling_get_memory", "Get memory usage statistics",
            json!({"type": "object", "properties": {}, "required": []})),
        tool("ue5_profiling_get_frame_stats", "Get frame statistics",
            json!({"type": "object", "properties": {}, "required": []})),

        // ===== File Tools =====
        tool("ue5_file_read", "Read a file from the project",
            json!({"type": "object", "properties": {"path": {"type": "string"}}, "required": ["path"]})),
        tool("ue5_file_write", "Write content to a file",
            json!({"type": "object", "properties": {"path": {"type": "string"}, "content": {"type": "string"}, "append": {"type": "boolean", "default": false}}, "required": ["path", "content"]})),
        tool("ue5_file_list", "List files in a directory",
...
fn tool_to_method(tool_name: &str) -> Option<&'static str> {
    match tool_name {
        ...
        // Actor
        "ue5_actor_list" => Some("level.listActors"),
        ...
        "ue5_viewport_get_active" => Some("viewport.getActive"),
        "ue5_viewport_set_active" => Some("viewport.setActive"),
        "ue5_viewport_get_camera" => Some("viewport.getCamera"),
        "ue5_viewport_set_camera" => Some("viewport.setCamera"),
        "ue5_viewport_focus_actor" => Some("viewport.focusActor"),
        "ue5_viewport_screenshot" => Some("viewport.screenshot"),
        ...
        "ue5_undo_history" => Some("transaction.getHistory"),
        // Material
        ...
        "ue5_material_set_scalar" => Some("material.setScalar"),
        "ue5_material_set_vector" => Some("material.setVector"),
        "ue5_material_set_texture" => Some("material.setTexture"),
        ...
        "ue5_sequencer_set_time" => Some("sequencer.setTime"),
        "ue5_sequencer_get_tracks" => Some("sequencer.getTracks"),
        "ue5_sequencer_add_actor" => Some("sequencer.addActor"),
        // Audio
        "ue5_audio_list" => Some("audio.list"),
        "ue5_audio_play" => Some("audio.play"),
        "ue5_audio_stop_all" => Some("audio.stopAll"),
        "ue5_audio_set_volume" => Some("audio.setVolume"),
        // Physics
        "ue5_physics_simulate" => Some("physics.simulate"),
        "ue5_physics_get_body_info" => Some("physics.getBodyInfo"),
        "ue5_physics_set_simulate" => Some("physics.setSimulate"),
        "ue5_physics_apply_impulse" => Some("physics.applyImpulse"),
        "ue5_collision_list_profiles" => Some("physics.listCollisionProfiles"),
        // Lighting
        "ue5_light_list" => Some("lighting.list"),
        "ue5_light_get" => Some("lighting.get"),
        "ue5_light_set_intensity" => Some("lighting.setIntensity"),
        "ue5_light_set_color" => Some("lighting.setColor"),
        "ue5_light_build" => Some("lighting.build"),
        "ue5_light_build_reflection_captures" => Some("lighting.buildReflectionCaptures"),
        // World Partition
        ...
        "ue5_profiling_get_frame_stats" => Some("profiling.getFrameStats"),
        // File
